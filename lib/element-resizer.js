...
function doRelativeResize (selector, container, ratio, center) {
  ...
  if (containerRatio > ratio) {
    ...
    if (center) {
      ...
      var parentHeight = selector.parent().outerHeight();
      var marginTop = (elemHeight - parentHeight) / 2;
    ...
    if (center) {
      ...
      var parentWidth = selector.parent().outerWidth();
      var marginLeft = (elemWidth - parentWidth) / 2;
